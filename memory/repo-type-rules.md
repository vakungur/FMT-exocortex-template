...
## Лестница принципов и соотнесение с репозиториями

| Уровень | Что означает | Где живёт |
|---------|-------------|-----------|
| ZPF / FPF | Универсальные принципы / корректность по академическим дисциплинам | Base |
| SPF | Методология (форма домена) — методология в Base, наполненный домен конкретной организации — в Pack | Base (методология) / Pack (инстанс) |
| TPF | Конкретные процедуры под организацию — код, планы, агентский операционный слой | DS |
| LPF | Практики роли конкретного носителя (не отдельный тип репо — cross-cutting классификация фрагментов внутри DS) | — |
