...
- [ ] **>80 строк → `/<summary>`:** Если документ будет >80 строк — СРАЗУ оформлять секции в collapsible. НЕ откладывать «на потом». Proposals, спецификации, архитектурные документы — почти всегда >80 строк.
